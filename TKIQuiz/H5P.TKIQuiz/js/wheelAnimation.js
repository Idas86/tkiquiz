...
(function ($, TKIQuiz) {
  /**
    ...
    @constructor
  */
  TKIQuiz.WheelAnimation = function (quiz, personalities, width, height, _getPath) {
    var self = this;
    ...
    */
    ...
    /**
      ...
      @param {CanvasRenderingContext2D} context
      @param {Object[]} personalities - a list of personalities from H5P.TKIQuiz
    */
